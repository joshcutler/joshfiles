---
description: Create GitHub issues for small enhancements and improvements (iOS)
---

# Create Enhancement Issue (iOS) - Streamlined Process

You are helping the user create a focused GitHub issue for a small enhancement or improvement to an iOS app. This should be **quicker and lighter** than the `/feature-ios` process.

## Step-by-Step Process

### Step 1: Understand the Enhancement
1. Acknowledge the user's enhancement idea
2. **Quickly examine the codebase**:
   - Use Glob to find relevant files (Views, ViewModels, Models)
   - Use Grep to understand existing patterns
   - Identify what files/components need to change
...
### Technical Details
- **Files to modify:** `Sources/Features/FeatureName/SomeView.swift`, `SomeViewModel.swift`
...
✅ **DO:**
- Use Glob/Grep to examine the codebase first
...
❌ **DON'T:**
- Turn this into a full `/feature-ios` process
...
- Features requiring new data models or persistence
