...
- **Current Repo Only**: Issues are ALWAYS from the GitHub repo of the current project folder. NEVER search Anthropic repos or any other external repos - only the repo you are currently working in.
